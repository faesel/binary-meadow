...
export const apps: App[] = [
  ...
  },
  {
    ...
    screenshots: [
      { src: '/screenshots/opdsy/home.jpg?v=3', alt: 'OPDSy home screen with continue reading and favourites' },
      { src: '/screenshots/opdsy/library.jpg?v=3', alt: 'OPDSy unified library browsing view' },
      { src: '/screenshots/opdsy/comic-list.jpg?v=3', alt: 'OPDSy comic series list with cover art' },
      { src: '/screenshots/opdsy/book-list.jpg?v=3', alt: 'OPDSy book list with cover art' },
      { src: '/screenshots/opdsy/comic-reading.jpg?v=3', alt: 'OPDSy comic page reader' },
      { src: '/screenshots/opdsy/book-reading.jpg?v=3', alt: 'OPDSy book reader view' },
      { src: '/screenshots/opdsy/book-reading-2.jpg?v=3', alt: 'OPDSy book reader with reading settings' },
      { src: '/screenshots/opdsy/downloads.jpg?v=3', alt: 'OPDSy offline downloads screen' },
      { src: '/screenshots/opdsy/settings.jpg?v=3', alt: 'OPDSy settings screen' },
      { src: '/screenshots/opdsy/libraries.jpg?v=3', alt: 'OPDSy connected OPDS servers list' },
